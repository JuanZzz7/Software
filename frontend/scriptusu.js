function guardar() {
    ...
    fetch("https://formulario12345.netlify.app/.netlify/functions/usuarios", requestOptions)
        .then((response) => {
            if (!response.ok) {
...
function listar() {
    ...
    fetch(`https://formulario12345.netlify.app/.netlify/functions/usuarios?iden=${ndoc}`, requestOptions)
        .then((response) => {
            if (!response.ok) {
